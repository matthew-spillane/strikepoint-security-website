  ...
  return (
    <PageShell>
      ...
      <section className="py-20">
        <div className="section-wrap">
          <SectionHeading eyebrow="Capabilities" title="Focused phishing analysis for faster security decisions" />
      ...
      <section className="section-wrap pb-24">
        <div className="card bg-gradient-to-r from-panel to-slate-900 p-8 text-center shadow-glow">
          ...
          <div className="mt-6 flex justify-center gap-4">
            <CtaButton href={primaryCta.href}>{primaryCta.label}</CtaButton>
            <Link href="/contact" className="link-focus rounded-full border border-slate-700 px-6 py-3 text-sm font-semibold text-slate-200 hover:text-white">
              Contact
            </Link>
          </div>
        </div>
